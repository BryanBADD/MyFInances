  ...
  return (
    <div>
      <div className="row accountName">
        <div className="col-lg-6 ">{props.account} Account</div>
        <div className="col-lg-2 vertical-center"><p className="navigation vertical-center" onClick={props.onAdd}>Add Transaction</p></div>
        <div className="col-lg-2 vertical-center"><p className="navigation vertical-center" onClick={props.onTransfer}>Transfer</p></div>
        <div className="col-lg-2 vertical-center"><p className="navigation vertical-center" onClick={props.onReconcile}>Reconcile</p></div>
      </div>
